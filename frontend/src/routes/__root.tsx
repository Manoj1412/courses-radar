...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "CourseRadar — Smart YouTube Course Finder" },
      { name: "description", content: "Find the best YouTube courses ranked by like ratio, comment sentiment, recency, and syllabus match." },
      { name: "author", content: "CourseRadar" },
